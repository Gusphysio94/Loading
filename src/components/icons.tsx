...
export function RunningIcon(props: IconProps) {
  return (
    ...
    >
      ...
      <path d="M4 22l5-7 4 1 1 6" />
      <path d="M18 12l-3 1-2-3 3-3 4 2-1 4z" />
      <path d="M9 8l-3 4 3 3" />
    </svg>
  );
}
...
export function TrophyIcon(props: IconProps) {
  return (
    ...
    >
      ...
      <path d="M6 4H4a2 2 0 0 0-2 2v1a3 3 0 0 0 3 3h1" />
      <path d="M18 4h2a2 2 0 0 1 2 2v1a3 3 0 0 1-3 3h-1" />
      <path d="M9 17h6" />
      <path d="M12 15v6" />
      <path d="M9 21h6" />
    </svg>
...
export function iconForTree(name: string, props: IconProps) {
  switch (name) {
    case "dumbbell":
